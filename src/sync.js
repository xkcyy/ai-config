...
const { cloneRepo, hasUncommittedChanges } = require('./git-utils');
const { normalizeRemoteDir, snapshotDirectory, snapshotPathsOnly } = require('./utils');
 ...
 * Main sync function
 */
exports.runSync = async function runSync(options) {
  const {
    target = process.cwd(),
